// wat (Michael Borczuk and Emma Buller)
// SoftDev
// K29 -- DOMfoolery++
// 2022-2-10
...
var renderFib = function() {
  document.getElementById("fibresult").innerHTML = "Fibonacci Sequence 11th number: " + fib(10);
};
...
var renderFact = function() {
  document.getElementById("factresult").innerHTML = "13! = " + fact(13);
};
...
var renderGcd = function() {
  document.getElementById("gcdresult").innerHTML = "GCD of 40 and 24: " + gcd(40, 24);
};
document.getElementById("fibButton").addEventListener("click", renderFib);
document.getElementById("factButton").addEventListener("click",renderFact);
document.getElementById("gcdButton").addEventListener("click",renderGcd);
